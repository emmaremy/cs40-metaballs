...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyPanelOpenGL_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyPanelOpenGL_t qt_meta_stringdata_MyPanelOpenGL = {
    {
QT_MOC_LITERAL(0, 0, 13), // "MyPanelOpenGL"
QT_MOC_LITERAL(1, 14, 10), // "updateTime"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "MyPanelOpenGL\0updateTime\0"
};
...
const QMetaObject MyPanelOpenGL::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_MyPanelOpenGL.data,
      qt_meta_data_MyPanelOpenGL,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyPanelOpenGL::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyPanelOpenGL.stringdata0))
